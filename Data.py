...
p2.image('partners/01.png',use_container_width=True)
p3.image('partners/01.png',use_container_width=True)
p4.image('partners/01.png',use_container_width=True)
p5.image('partners/01.png',use_container_width=True)
p6.image('partners/01.png',use_container_width=True)
p7.image('partners/01.png',use_container_width=True)
