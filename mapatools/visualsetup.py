...
def load_visual_identity(header_image_path, background_image_path = 'resources/background.svg'):
    ...
    p1.image('resources/partners/01.png',width=40)
    p2.image('resources/partners/07.png',width=40)
    p3.image('resources/partners/03.png',width=40)
    p4.image('resources/partners/04.png',width=40)
    p5.image('resources/partners/05.png',width=40)
    p6.image('resources/partners/06.png',width=40)
    p7.image('resources/partners/02.png',width=40)
